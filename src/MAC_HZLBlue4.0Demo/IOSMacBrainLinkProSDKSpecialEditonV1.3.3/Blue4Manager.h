...
-(void)writeToProBWithCode:(NSData *)code;
-(void)writeToProCWithCode:(NSData *)code;
-(void)writeToProDWithCode:(NSData *)code;
-(void)writeToProEWithCode:(NSData *)code;
-(void)writeToProFWithCode:(NSData *)code;
@end
